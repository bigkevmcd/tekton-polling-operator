...
import (
	...
	"github.com/bigkevmcd/tekton-polling-operator/controllers"
...
func init() {
	...
	utilruntime.Must(pollingv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "15e22733.tekton.dev",
	})
	if err != nil {
	...
	if err := pipelinev1.AddToScheme(mgr.GetScheme()); err != nil {
		setupLog.Error(err, "unable to register pipeline schema", "controller", "Repository")
		os.Exit(1)
	}
	...
	if err = (&controllers.RepositoryReconciler{
		...
		PollerFactory: func(repo *pollingv1alpha1.Repository, endpoint, token string) git.CommitPoller {
