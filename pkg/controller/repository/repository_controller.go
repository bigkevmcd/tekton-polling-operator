...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &pollingv1alpha1.Repository{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRepository) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &pollingv1alpha1.Repository{}
	...
	// Set Repository instance as the owner and controller
...
func newPodForCR(cr *pollingv1alpha1.Repository) *corev1.Pod {
