...
func (g GitLabPoller) Poll(repo string, pr pollingv1alpha1.PollStatus) (pollingv1alpha1.PollStatus, error) {
	...
	return pollingv1alpha1.PollStatus{Ref: pr.Ref, SHA: gc[0].ID, ETag: resp.Header.Get("ETag")}, nil
}
